let canvas = document.getElementById("hyperdrive");
...
const randHSLA = (h, h1, s = 100, s1 = 100, l = 50, l1 = 50, a = 1, a1 = 1) => {
	return `hsla(${randI(h, h1) % 360},${randI(s, s1)}%,${randI(l, l1)}%,${rand(
		a,
		a1
	)})`;
};
...
const p = { x: 0, y: 0 };
const MIN_SPEED = 1.025;
const MAX_SPEED = 1.75;
var hyperSpeed = MIN_SPEED;
